package cn.iocoder.yudao.module.room.controller.admin.roomstatisconfig.vo;
...
@Schema(description = "管理后台 - 机房计算服务配置分页 Request VO")
@Data
@EqualsAndHashCode(callSuper = true)
@ToString(callSuper = true)
public class RoomStatisConfigPageReqVO extends PageParam {
