 ...
 * @date 2024/5/6 15:24
 */
@Schema(description = "管理后台 - 通道列有功功率趋势 Response VO")
@Data
public class AisleActivePowDTO {
    ...
    private List<AisleActivePowTrendDTO> todayList;

    /**
     * 昨日总有功功率趋势数据
     */
    @Schema(description = "昨日总有功功率趋势数据", example = "[]")
    private List<AisleActivePowTrendDTO> yesterdayList;
}