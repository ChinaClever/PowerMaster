package cn.iocoder.yudao.module.aisle.constant;
...
public class AisleConstants {
     ...
     * 始端箱功率历史数据表（实时）
     */
    public static final String AISLE_HDA_POW_REALTIME = "aisle_hda_pow_realtime";

    /**
     * 始端箱功率历史数据表（按小时算）
     */
    public static final String AISLE_HDA_POW_HOUR = "aisle_hda_pow_hour";

    /**
     * 始端箱功率历史数据表（按天算）
     */
    public static final String AISLE_HDA_POW_DAY = "aisle_hda_pow_day";
