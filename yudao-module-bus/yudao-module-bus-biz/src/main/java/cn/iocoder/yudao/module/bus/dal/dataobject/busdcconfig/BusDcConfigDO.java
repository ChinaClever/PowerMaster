package cn.iocoder.yudao.module.bus.dal.dataobject.busdcconfig;
 ...
 * @author clever
 */
@TableName("bus_dc_config")
@KeySequence("bus_dc_config_seq") // 用于 Oracle、PostgreSQL、Kingbase、DB2、H2 数据库的主键自增。如果是 MySQL 等数据库，可不写。
@Data
@ToString(callSuper = true)
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class BusDcConfigDO  {
