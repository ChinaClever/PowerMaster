...
public interface BusEnergyConsumptionService {
     ...
     */
    Map<String, Object> getOneDaySumData(String timeRangeType) throws IOException;
...
//------------------------------------------------------------------------
     ...
     */
    Map<String, Object> getBoxOneDaySumData(String timeRangeType) throws IOException;
