...
@ColumnWidth(30)
@HeadRowHeight(20)
public class BoxHourAndDayLineExportDetailVO {
    ...
    private Double cur_thd_avg_value;
    @NumberFormat("0.0")
    @ExcelProperty({"电流谐波最大值","电流谐波最大值"})
    private Double cur_thd_max_value;
    @ExcelProperty({"电流谐波最大值","发生时间"})
    private String cur_thd_max_time;
    @NumberFormat("0.0")
    @ExcelProperty({"电流谐波最小值","电流谐波最小值"})
    private Double cur_thd_min_value;
    @ExcelProperty({"电流谐波最小值","发生时间"})
