...
@ColumnWidth(30)
@HeadRowHeight(20)
public class BusHourAndDayLinePageRespVO {
    ...
    @NumberFormat("0")
    @ExcelProperty("平均负载率")
    private Double load_rate_avg_value;
    @ExcelProperty("最大负载率时间")
    private String load_rate_max_time;
    @NumberFormat("0")
    @ExcelProperty("最大负载率")
    private Double load_rate_max_value;
    @ExcelProperty("最小负载率时间")
    private String load_rate_min_time;
    @NumberFormat("0")
    @ExcelProperty("最小负载率")
    private Double load_rate_min_value;
