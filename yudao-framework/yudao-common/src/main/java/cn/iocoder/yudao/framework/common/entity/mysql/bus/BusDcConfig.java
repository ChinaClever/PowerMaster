 ...
 */
@Data
@TableName(value = "bus_dc_config")
public class BusDcConfig implements Serializable {
     ...
     * 定时存储任务开关
     */
    private int fixStore;

    /**
     * 变化存储任务开关
     */
    private int changeStore;

    /**
     * 电能存储任务开关
     */
    private int eleStore;

    /**
     * redis保存任务开关
     */
    private int redisSwitch;
