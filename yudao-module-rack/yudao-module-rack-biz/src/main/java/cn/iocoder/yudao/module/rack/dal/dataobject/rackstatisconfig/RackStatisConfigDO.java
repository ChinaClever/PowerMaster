package cn.iocoder.yudao.module.rack.dal.dataobject.rackstatisconfig;
 ...
 * @author clever
 */
@TableName("rack_statis_config")
@KeySequence("rack_statis_config_seq") // 用于 Oracle、PostgreSQL、Kingbase、DB2、H2 数据库的主键自增。如果是 MySQL 等数据库，可不写。
@Data
...
@NoArgsConstructor
@AllArgsConstructor
public class RackStatisConfigDO extends BaseDO {
