...
public class AlarmInit {
    ...
    public void ListenTableChange() {
        ListenerThreadPoolConfig.getThreadPool().execute(() -> {
            List<String> tableList = new ArrayList<>(Arrays.asList(DBTable.PDU_INDEX, DBTable.BUS_INDEX, DBTable.CABINET_INDEX, DBTable.ALARM_LOG_RECORD, DBTable.ALARM_LOG_RECORD));
