      ...
      series: [
        {
          ...
          data: [
            { value: vol_value[0].toFixed(2), name: 'A相电压', itemStyle: { color: '#E5B849' } },
            { value: vol_value[1].toFixed(2), name: 'B相电压', itemStyle: { color: '#C8603A' } },
            { value: vol_value[2].toFixed(2), name: 'C相电压', itemStyle: { color: '#AD3762' } },
          ]
        }
      ]
    }
