    ...
    if (chartContainer.value && instance) {
      ...
      if (realtimeChart) {
        realtimeChart.setOption({
          ...
          legend: { data: ['总有功功率', '总视在功率', '总无功功率', '功率因素'],
                selected: {  "总有功功率": true, "总视在功率": false, "总无功功率": false, "功率因素": false, }
              },
      ...
      if ( newActiveName == 'realtimeTabPane'){
          ...
          if ( isHaveData.value == true ){
            ...
            if (realtimeChart) {
              realtimeChart.setOption({
                ...
                title: { text: ''},
                tooltip: { trigger: 'axis', formatter: customTooltipFormatter},
                legend: { data:  ['有功功率', '视在功率', '无功功率', '功率因素', '电压', '电流', '负载率', '电流谐波含量'],
                          selected: {  "有功功率": true, "视在功率": false, "无功功率": false, "功率因素": false
                            , "电压": false, "电流": false, "负载率": false, "电流谐波含量": false
                           }},
                grid: {left: '3%', right: '4%', bottom: '3%',containLabel: true},
                toolbox: {feature: {  restore:{}, saveAsImage: {}}},
                xAxis: {type: 'category', boundaryGap: false, data:createTimeData.value},
        ...
        if ( isHaveData.value == true ){
          ...
          if (realtimeChart) {
            ...
            tooltip: { trigger: 'axis', formatter: customTooltipFormatter},
            legend: { data: [ '平均有功功率', '最大有功功率', '最小有功功率','平均无功功率', '最大无功功率', '最小无功功率','平均视在功率', '最大视在功率', '最小视在功率',
                               '平均电流', '最大电流', '最小电流','平均电压', '最大电压', '最小电压','平均电流谐波含量', '最大电流谐波含量', '最小电流谐波含量'],
                      selected: {  平均有功功率: true, 最大有功功率: true, 最小有功功率: true, 平均无功功率: false, 最大无功功率: false, 最小无功功率: false,
          ...
          if ( isHaveData.value == true ){
            ...
            if (realtimeChart) {
              realtimeChart.setOption({
                ...
                title: { text: ''},
                tooltip: { trigger: 'axis', formatter: customTooltipFormatter},
                legend: { data:  ['有功功率', '视在功率', '无功功率', '功率因素', '电压', '电流'],
                          selected: {  "有功功率": true, "视在功率": false, "无功功率": false, "功率因素": false, "电压": false, "电流": false }},
                grid: {left: '3%', right: '4%', bottom: '3%',containLabel: true},
                toolbox: {feature: {  restore:{}, saveAsImage: {}}},
                xAxis: {type: 'category', boundaryGap: false, data:createTimeData.value},
                yAxis: { type: 'value'},
                series: [
                  ...
                  {name: '功率因素', type: 'line', symbol: 'none', data: powerFactorData.value},
                  {name: '视在功率', type: 'line', symbol: 'none', data: powApparentData.value},
                  {name: '电压', type: 'line', symbol: 'none', data: volValueData.value},
                  {name: '电流', type: 'line', symbol: 'none', data: curValueData.value},
                ],
                dataZoom:[{type: "inside"}],
              });
            }
        ...
        if ( isHaveData.value == true ){
          ...
          if (realtimeChart) {
            realtimeChart.setOption({
              title: { text: ''},
              tooltip: { trigger: 'axis', formatter: customTooltipFormatter},
              legend: { data: ['有功功率', '视在功率', '无功功率', '功率因素'],
                    selected: {  "有功功率": true, "视在功率": false, "无功功率": false, "功率因素": false, }
                  },
              grid: {left: '3%', right: '4%', bottom: '3%',containLabel: true},
              toolbox: {feature: {  restore:{}, saveAsImage: {}}},
  ...
  realtimeChart?.on('legendselectchanged', function (params) {
    ...
    switch (legendName) {
     ...
     if (params.selected[legendName]){
      ...
      case '总无功功率':
      if (params.selected[legendName]){
          optionsToUpdate = {  "总无功功率": true , "功率因素": false};
      }
        break;

      case '功率因素':
      if (params.selected[legendName]){
          optionsToUpdate = {  "功率因素": true , "总有功功率": false, "总无功功率": false, "总视在功率": false};
      }
        break;
...
function totalAndOutletHourAndDayLegendListener(realtimeChart) {
  realtimeChart?.on('legendselectchanged', function (params) {
    ...
    switch (legendName) {
      ...
      case '最小视在功率':
      if (params.selected[legendName]){
        optionsToUpdate = { "平均视在功率": true, "最大视在功率": true, "最小视在功率": true};
      }
        break;
      ...
      case '最小有功功率':
      if (params.selected[legendName]){
        optionsToUpdate = { "平均有功功率": true, "最大有功功率": true, "最小有功功率": true};
      }
        break;
      ...
      case '最小无功功率':
      if (params.selected[legendName]){
        optionsToUpdate = { "平均无功功率": true, "最大无功功率": true, "最小无功功率": true };
      }
        break;
...
function lineRealtimeLegendListener(realtimeChart) {
  realtimeChart?.on('legendselectchanged', function (params) {
    ...
    switch (legendName) {
     ...
     if (params.selected[legendName]){
          optionsToUpdate = { "有功功率": true,  "功率因素": false , "电压": false, 
                            "电流": false, "负载率": false, "电流谐波含量": false }
        }
        break;
      ...
      if (params.selected[legendName]){
        optionsToUpdate = { "功率因素": true,  "有功功率": false,  "视在功率": false,  
                           "无功功率": false , "电压": false, "电流": false, "负载率": false, "电流谐波含量": false }
      }
        break;
      ...
      if (params.selected[legendName]){
        optionsToUpdate = { "电流": true, "功率因素": false , "有功功率": false,  "视在功率": false,  
                             "无功功率": false , "电压": false,  "负载率": false, "电流谐波含量": false }
      }
        break;
      ...
      if (params.selected[legendName]){
        optionsToUpdate = { "电压": true, "功率因素": false , "有功功率": false, "电流": false, 
                          "视在功率": false,  "无功功率": false, "负载率": false, "电流谐波含量": false}
      }
        break;

      case '负载率':
      if (params.selected[legendName]){
        optionsToUpdate = { "负载率": true, "电压": false, "电流谐波含量": false, "功率因素": false ,"电流": false,  
      ...
      case '电流谐波含量':
      if (params.selected[legendName]){
        optionsToUpdate = { "电流谐波含量": true, "电压": false, "功率因素": false ,"电流": false,  
                            "有功功率": false,  "视在功率": false, "无功功率": false, "负载率": false, }
      }
        break;
    ...
    realtimeChart?.setOption({
      legend: {
        data: ['有功功率', '视在功率', '无功功率', '功率因素', '电压', '电流', '负载率', '电流谐波含量'],
        selected: optionsToUpdate
      },
    });
  });
    ...
    switch (legendName) {
      ...
      if (params.selected[legendName]){
        optionsToUpdate = { "平均电压": true, "最大电压": true, "最小电压": true, "平均视在功率": false, "最大视在功率": false, "最小视在功率": false,
                 "平均有功功率": false, "最大有功功率": false, "最小有功功率": false,"平均无功功率": false, "最大无功功率": false, "最小无功功率": false,
                 "平均电流": false, "最大电流": false, "最小电流": false, "平均电流谐波含量": false, "最大电流谐波含量": false, "最小电流谐波含量": false }
          }
        break;
      ...
      case '最小电流谐波含量':
      if (params.selected[legendName]){
        optionsToUpdate = { "平均电流谐波含量": true, "最大电流谐波含量": true, "最小电流谐波含量": true, "平均视在功率": false, "最大视在功率": false, "最小视在功率": false,
                 "平均有功功率": false, "最大有功功率": false, "最小有功功率": false,"平均无功功率": false, "最大无功功率": false, "最小无功功率": false,
                 "平均电流": false, "最大电流": false, "最小电流": false, "平均电压": false, "最大电压": false, "最小电压": false }
          }
        break;
...
function loopRealtimeLegendListener(realtimeChart) {
  realtimeChart?.on('legendselectchanged', function (params) {
    ...
    switch (legendName) {
      case '有功功率':
     if (params.selected[legendName]){
          optionsToUpdate = { "有功功率": true,  "功率因素": false , "电压": false, "电流": false}
        }
        break;

      case '视在功率':
      if (params.selected[legendName]){
          optionsToUpdate = { "视在功率": true,  "功率因素": false , "电压": false, "电流": false}
      }
        break;

      case '无功功率':
      if (params.selected[legendName]){
          optionsToUpdate = { "无功功率": true,  "功率因素": false , "电压": false, "电流": false}
      }
        break;
    ...
    realtimeChart?.setOption({
      legend: {
        data: ['有功功率', '视在功率', '无功功率', '功率因素', '电压', '电流'],
        selected: optionsToUpdate
      },
    });
  });
...
function outletRealtimeLegendListener(realtimeChart) {
  realtimeChart?.on('legendselectchanged', function (params) {
    ...
    switch (legendName) {
      case '有功功率':
     if (params.selected[legendName]){
          optionsToUpdate = {  "有功功率": true , "功率因素": false};
        }
        break;

      case '视在功率':
      if (params.selected[legendName]){
          optionsToUpdate = {  "视在功率": true , "功率因素": false};
      }
        break;

      case '无功功率':
      if (params.selected[legendName]){
          optionsToUpdate = {  "无功功率": true , "功率因素": false};
      }
        break;

      case '功率因素':
      if (params.selected[legendName]){
          optionsToUpdate = {  "功率因素": true , "有功功率": false, "无功功率": false, "视在功率": false};
      }
        break;
