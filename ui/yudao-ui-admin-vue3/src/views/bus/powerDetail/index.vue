      ...
      <div  class="right-part">
        ...
        <div  class="center-bottom-part">
          ...
          <div  class="block-part">
            ...
            <div  class="content-part">
              <p  class="AColor">A相绕组温度 <span  class="vale-part AColor">{{redisData?.tempA}}</span>℃</p>
              <p  class="BColor">B相绕组温度 <span  class="vale-part BColor">{{redisData?.tempB}}</span>℃</p>
              <p  class="CColor">C相绕组温度 <span  class="vale-part CColor">{{redisData?.tempC}}</span>℃</p>
            </div><!---->
            <div  class="content-part">
