<template>
  <CommonMenu :dataList="navList" @check="handleCheck" navTitle="母线插接箱实时能耗">
    <template #NavInfo>
    <br/>    <br/> 
        <div class="nav_data">
...
const handleExport = async () => {
  try {
    ...
    const data = await EnergyConsumptionApi.getBoxEleTotalRealtimeExcel(queryParams, axiosConfig)
    await download.excel(data, '插接箱实时能耗趋势.xlsx')
  } catch (error) {
    // 处理异常
