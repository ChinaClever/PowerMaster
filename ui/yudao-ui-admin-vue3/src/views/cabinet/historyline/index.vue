<template>
 <CommonMenu1 :dataList="navList" @node-click="handleClick" navTitle="机柜电力分析" :showCheckbox="false" :hightCurrent="true" :currentKey="currentKey" :highlightTypes="[3]" :defaultExpandedKeys="defaultExpandedKeys">
    <template #NavInfo>
      <br/> 
      <div class="nav_data">
