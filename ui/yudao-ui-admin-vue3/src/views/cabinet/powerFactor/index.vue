<template>
  <CommonMenu @check="handleCheck"  @node-click="handleClick" :showSearch="true" :dataList="cabinetList" navTitle="机柜功率因素">
    <template #NavInfo>
      <div>
        <!-- <div class="header">
...
const getDetail = async () => {
  const data = await CabinetApi.getCabinetPFDetail(detailQueryParams);
