...
const updateChartData = () => {
  if (props.curChartData && props.curChartData.aPath) {
    L1Data.value = props.curChartData.aPath.map((item) => item.powActiveA.toFixed(3));
    L2Data.value = props.curChartData.aPath.map((item) => item.powActiveB.toFixed(3));
    L3Data.value = props.curChartData.aPath.map((item) => item.powActiveTotal.toFixed(3));
