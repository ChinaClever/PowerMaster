      ...
      >
        <el-row :gutter="24">
          ...
          <el-col :span="12">
            ...
            <el-form-item label="日用能限制" prop="eleLimitDay">
              <el-input v-model="formData.eleLimitDay" type="number" placeholder="请输入日用能限制" />
            </el-form-item>            
            ...
            <el-form-item label="月用能限制" prop="eleLimitMonth">
              <el-input v-model="formData.eleLimitMonth" type="number" placeholder="请输入日用能限制" />
            </el-form-item>   
          </el-col>         
        </el-row>
        <el-row justify="end">
...
const formData = ref({
  ...
  eleLimitDay: undefined,
  eleAlarmMonth: undefined,
  eleLimitMonth: undefined,
}) as any
...
const formRules = reactive({
  ...
  eleLimitDay: [{ required: true, message: '日用能限制不能为空', trigger: 'blur' },
  {validator: (rule: any, value: any, callback: any) => {
                if(value){
                  if (value < 0){
                    return callback(new Error('应大于0'));
  ...
  eleLimitMonth: [{ required: true, message: '月用能限制不能为空', trigger: 'blur' },
  {validator: (rule: any, value: any, callback: any) => {
                if(value){
                  if (value < 0){
                    return callback(new Error('应大于0'));
