<template>
  <CommonMenu :dataList="navList" @node-click="handleClick" navTitle="柜列能耗排名" :showCheckbox="false">
    <template #NavInfo>
      <br/>    <br/> 
      <div class="nav_data">
      ...
      <div class="nav_content">
        <el-descriptions title="全部柜列耗电量极值记录" direction="vertical" :column="1" border >
