...
const dataWithPercent = computed(() => {
  ...
  return [
    { value: props.max.L1, name: 'A相电流',itemStyle: { color: '#075F71' } },
    { value: props.max.L2, name: 'B相电流' ,itemStyle: { color: '#119CB5' }},
    { value: props.max.L3, name: 'C相电流',itemStyle: { color: '#45C0C9' } }
  ];
});
