...
export const HistoryDataApi = {
  ...
  getBusHistoryDataPage: async (params: any) => {
    return await request.post({ url: `/bus/history-data/bus-page`, params })
  },

  // 查询母线插接箱历史数据分页
  getBoxHistoryDataPage: async (params: any) => {
    return await request.post({ url: `/bus/history-data/box-page`, params })
  },
  ...
  exportBoxHistoryData: async (params, axiosConfig) => {
    return await request.downloadPost({ url: `/bus/history-data/box-export-excel`, params, ...axiosConfig })
  },

  // 导出母线始端箱历史数据 Excel
  exportBusHistoryData: async (params, axiosConfig) => {
    return await request.downloadPost({ url: `/bus/history-data/bus-export-excel`, params, ...axiosConfig })
  },
