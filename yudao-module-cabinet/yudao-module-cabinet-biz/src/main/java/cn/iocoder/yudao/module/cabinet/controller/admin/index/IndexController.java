...
public class IndexController {
    ...
    @GetMapping("/getEleByCabinetId")
    @Operation(summary = "根据机柜id获取耗电量")
    public CommonResult<Map<String, Double>> getEleByCabinetId(String Id,Integer timeType,@DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss") LocalDateTime oldTime,@DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss") LocalDateTime newTime) throws IOException {
        return success(indexService.getEleByCabinetId(Id,timeType,oldTime,newTime));
    }

    @GetMapping("/getEleByAisle")
    @Operation(summary = "根据柜列id获取机柜耗电量")
