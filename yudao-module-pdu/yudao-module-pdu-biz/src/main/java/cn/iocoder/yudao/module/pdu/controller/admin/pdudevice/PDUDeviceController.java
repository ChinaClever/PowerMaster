...
public class PDUDeviceController {
    ...
    public CommonResult<Map> getPduHdaLineHisdataKey(String devKey, Integer type,@DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss") LocalDateTime oldTime,@DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss") LocalDateTime newTime,Integer dataType) {
        System.out.println("oldTime"+oldTime);
        System.out.println("newTime"+newTime);
        return success(pDUDeviceService.getPduHdaLineHisdataKey(devKey, type,oldTime,newTime,dataType));
    }
